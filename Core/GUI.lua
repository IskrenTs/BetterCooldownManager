...
local function CreateGlobalSettings(parentContainer)
    ...
    disableChatPrintsCheckbox:SetLabel("Display AddOn Configuration Print")
    disableChatPrintsCheckbox:SetValue(BCDM.db.global.DisplayChatPrint)
    disableChatPrintsCheckbox:SetCallback("OnValueChanged", function(_, _, value) BCDM.db.global.DisplayChatPrint = value end)
    disableChatPrintsCheckbox:SetCallback("OnEnter", function()
        GameTooltip:SetOwner(disableChatPrintsCheckbox.frame, "ANCHOR_CURSOR")
        GameTooltip:AddLine("|cFFFF4040Disabling|r this will prevent the chat print explaining how to access BetterCooldownManager settings.", 1, 1, 1, false)
        GameTooltip:Show()
    end)
    disableChatPrintsCheckbox:SetCallback("OnLeave", function() GameTooltip:Hide() end)
