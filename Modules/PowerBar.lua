...
local function CreatePowerBar()
    ...
    PowerBar:SetBackdrop({bgFile = BCDM.Media.BGTexture, edgeFile = "Interface\\Buttons\\WHITE8X8", edgeSize = 1})
    ...
    PowerBar.StatusBar:SetStatusBarTexture(BCDM.Media.FGTexture)
...
function BCDM:UpdatePowerBar()
    ...
    if BCDM.PowerBar then
        ...
        BCDM.PowerBar:SetBackdrop({bgFile = BCDM.Media.BGTexture, edgeFile = "Interface\\Buttons\\WHITE8X8", edgeSize = 1})
        BCDM.PowerBar:SetBackdropColor(unpack(PowerBarDB.BGColour))
        BCDM.PowerBar:SetBackdropBorderColor(0, 0, 0, 1)
        BCDM.PowerBar.StatusBar:SetStatusBarTexture(BCDM.Media.FGTexture)
